...
impl From<InitializeStatus> for RedError {
    fn from(value: InitializeStatus) -> Self {
        match value {
            InitializeStatus::ISLibraryNotLoaded                  => Self::LibraryNotLoaded,
            InitializeStatus::ISR3DSDKLibraryNotFound             => Self::R3DSDKLibraryNotFound,
            InitializeStatus::ISRedCudaLibraryNotFound            => Self::RedCudaLibraryNotFound,
            InitializeStatus::ISRedOpenCLLibraryNotFound          => Self::RedOpenCLLibraryNotFound,
            InitializeStatus::ISR3DDecoderLibraryNotFound         => Self::R3DDecoderLibraryNotFound,
            InitializeStatus::ISRedMetalLibraryNotFound           => Self::RedMetalLibraryNotFound,
            InitializeStatus::ISLibraryVersionMismatch            => Self::LibraryVersionMismatch,
            InitializeStatus::ISInvalidR3DSDKLibrary              => Self::InvalidR3DSDKLibrary,
            InitializeStatus::ISInvalidRedCudaLibrary             => Self::InvalidRedCudaLibrary,
            InitializeStatus::ISInvalidRedOpenCLLibrary           => Self::InvalidRedOpenCLLibrary,
            InitializeStatus::ISInvalidR3DDecoderLibrary          => Self::InvalidR3DDecoderLibrary,
            InitializeStatus::ISInvalidRedMetalLibrary            => Self::InvalidRedMetalLibrary,
            InitializeStatus::ISRedCudaLibraryInitializeFailed    => Self::RedCudaLibraryInitializeFailed,
            InitializeStatus::ISRedOpenCLLibraryInitializeFailed  => Self::RedOpenCLLibraryInitializeFailed,
            InitializeStatus::ISR3DDecoderLibraryInitializeFailed => Self::R3DDecoderLibraryInitializeFailed,
            InitializeStatus::ISR3DSDKLibraryInitializeFailed     => Self::R3DSDKLibraryInitializeFailed,
            InitializeStatus::ISRedMetalLibraryInitializeFailed   => Self::RedMetalLibraryInitializeFailed,
            InitializeStatus::ISInvalidPath                       => Self::InvalidPath,
            InitializeStatus::ISInternalError                     => Self::InternalError,
            InitializeStatus::ISMetalNotAvailable                 => Self::MetalNotAvailable,
            InitializeStatus::ISInitializeOK                      => panic!("Cannot convert ISInitializeOK to RedError"),
        }
    }
}
impl From<LoadStatus> for RedError {
    fn from(value: LoadStatus) -> Self {
        match value {
            LoadStatus::LSClipLoaded        => panic!("Cannot convert LSClipLoaded to RedError"),
            LoadStatus::LSPathNotFound      => Self::ClipPathNotFound,
            LoadStatus::LSFailedToOpenFile  => Self::ClipFailedToOpenFile,
            LoadStatus::LSNotAnR3DFile      => Self::ClipNotAnR3DFile,
            LoadStatus::LSClipIsEmpty       => Self::ClipIsEmpty,
            LoadStatus::LSOutOfMemory       => Self::ClipOutOfMemory,
            LoadStatus::LSUnknownError      => Self::ClipUnknownError,
            LoadStatus::LSNoClipOpen        => Self::ClipNoClipOpen,
            LoadStatus::LSNotInitialized    => Self::ClipNotInitialized,
        }
    }
}
...
impl From<DecodeStatus> for RedError {
    fn from(value: DecodeStatus) -> Self {
        match value {
            DecodeStatus::DSDecodeOK               => panic!("Cannot convert DSDecodeOK to RedError"),
            DecodeStatus::DSOutputBufferInvalid    => Self::OutputBufferInvalid,
            DecodeStatus::DSRequestOutOfRange      => Self::RequestOutOfRange,
            DecodeStatus::DSInvalidParameter       => Self::InvalidParameter,
            DecodeStatus::DSIsDroppedFrame         => Self::IsDroppedFrame,
            DecodeStatus::DSDecodeFailed           => Self::DecodeFailed,
            DecodeStatus::DSOutOfMemory            => Self::OutOfMemory,
            DecodeStatus::DSUnknownError           => Self::UnknownError,
            DecodeStatus::DSNoClipOpen             => Self::NoClipOpen,
            DecodeStatus::DSCannotReadFromFile     => Self::CannotReadFromFile,
            DecodeStatus::DSInvalidPixelType       => Self::InvalidPixelType,
            DecodeStatus::DSNotAnHDRxClip          => Self::NotAnHDRxClip,
            DecodeStatus::DSCancelled              => Self::Cancelled,
            DecodeStatus::DSUnsupportedClipFormat  => Self::UnsupportedClipFormat,
            DecodeStatus::DSParameterUnsupported   => Self::ParameterUnsupported,
            DecodeStatus::DSDecoderNotOpened       => Self::DecoderNotOpened,
        }
    }
}
